...
oxwm.set_modkey("Mod1") -- This is for Mod + mouse binds, such as drag/resize
oxwm.set_tags(tags)
...
oxwm.border.set_focused_color(colors.dark_blue)
-- Color of unfocused window borders
oxwm.border.set_unfocused_color(colors.white)
...
oxwm.key.bind({ "Control", "Mod1" }, "Delete", oxwm.spawn({ "rofi -show power-menu" }))
...
-- Audio control
oxwm.key.bind({ "" }, "XF86AudioRaiseVolume", oxwm.spawn({ "wpctl set-volume --limit 1.0 @DEFAULT_AUDIO_SINK@ 0.1+" }))
oxwm.key.bind({ "" }, "XF86AudioLowerVolume", oxwm.spawn({ "wpctl set-volume @DEFAULT_AUDIO_SINK@ 0.1-" }))
oxwm.key.bind({ "" }, "XF86AudioMute", oxwm.spawn({ "wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle" }))
oxwm.key.bind({ "Mod4", "Shift" }, "P", oxwm.spawn({ "alacritty -e wiremix -v output" }))

-- Clipboard manager
oxwm.key.bind({ "Mod4" }, "V", oxwm.spawn({ "clipcat-menu insert" }))
...
oxwm.key.bind({ modkey }, "J", oxwm.set_master_factor(-5))
oxwm.key.bind({ modkey }, "Down", oxwm.set_master_factor(-5))
oxwm.key.bind({ modkey }, "K", oxwm.set_master_factor(5))
oxwm.key.bind({ modkey }, "Up", oxwm.set_master_factor(5))
